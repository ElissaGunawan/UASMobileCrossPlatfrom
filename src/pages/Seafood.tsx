import { IonCard, IonModal, IonCol, IonContent, IonGrid, IonImg, IonLabel, IonPage, IonRow, IonIcon, IonButton, IonSegment, IonSegmentButton, IonSelect, IonSelectOption } from "@ionic/react";
      ...
      <IonCard>
        ...
        <IonGrid class="ion-text-center">
            ...
            <IonCol class="ion-text-center">
              ...
              <IonLabel className="type-text" color="dark" position="floating">
                <IonModal isOpen={showModal}>
                  <p>asdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasd</p>
                  <IonButton onClick={() => setShowModal(false)}>Close Modal</IonButton>
                </IonModal>
