import { IonCard, IonModal, IonCol, IonContent, IonGrid, IonImg, IonLabel, IonPage, IonRow, IonIcon, IonButton, IonSegment, IonSegmentButton, IonSelect, IonSelectOption, IonBackButton } from "@ionic/react";
